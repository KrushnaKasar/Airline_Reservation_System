        ...
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(
                        ...
                        "/api/flight/book/fetch/seatDetails",
                        "/api/flight/fetch/all",
                        "/api/flight/search",
                        "/api/flight/class/all",
                        "/api/airport/fetch/all",
                        "/api/flight/book/fetch"
                ).permitAll()

                // ✅ ADMIN APIs
                .requestMatchers(
                        "/api/airplane/add",
                        "/api/airplane/fetch/all",
                        "/api/airport/add",
                        "/api/flight/book/fetch/all",
                        "/api/flight/add",
                        "/api/flight/status/all",
                        "/api/flight/update/status",
                        "/api/user/fetch/role",
                ...
                .requestMatchers(
                        "/api/flight/book/add",
                        "/api/flight/book/fetch/user",
                        "/api/flight/book/ticket/cancel",
                        "/api/user/add/wallet/money",
                        "/api/user/passenger/wallet/fetch"
                ).hasAuthority(UserRole.ROLE_PASSENGER.value())

                // ✅ BOTH ADMIN + PASSENGER
