...
import com.airlinereservation.dto.ForgotPasswordRequestDto;
import com.airlinereservation.dto.RegisterUserRequestDto;
import com.airlinereservation.dto.ResetPasswordRequestDto;
...
import com.airlinereservation.service.EmailService;
...
public class UserResource {
    ...
    // ==================================================
    public ResponseEntity<CommonApiResponse> forgotPassword(ForgotPasswordRequestDto request) {
        ...
        if (user == null) {
            response.setResponseMessage("Email not registered!");
